...
1. Tratamento de Valores Nulos
	...
	Entrada: apartments_for_rent_classified_10K.csv
...
5. Tratamento de Colunas Textuais (Opcional)

	Script: TratarColunasTextuais.py
	Descrição: Aplica TF-IDF às colunas textuais (title, body, amenities) para representá-las numericamente.
